            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                <button
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl font-extrabold text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 hover:from-blue-700 hover:to-indigo-700 active:scale-95 shadow-xl shadow-blue-600/30 transition-all cursor-pointer text-base"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-xl font-bold text-slate-800 bg-white border-2 border-slate-200 hover:border-blue-300 hover:bg-slate-50 shadow-sm transition-all cursor-pointer text-sm"
                >
              ...
              {/* Trust Badges & Hospital Highlights */}
              <div className="pt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-slate-200/80 max-w-xl mx-auto lg:mx-0 text-left">
                <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200/60 shadow-xs">
                ...
                <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200/60 shadow-xs">
                  <h4 className="text-lg font-black text-slate-900">8 AM - 8 PM</h4>
                  <p className="text-[11px] text-slate-500 font-medium">OPD Working Hours</p>
                </div>
                <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200/60 shadow-xs">
                  <h4 className="text-lg font-black text-slate-900">15+</h4>
                  <p className="text-[11px] text-slate-500 font-medium">Specialty Depts</p>
                </div>
                <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200/60 shadow-xs">
                  <h4 className="text-lg font-black text-slate-900">99.9%</h4>
                  <p className="text-[11px] text-slate-500 font-medium">Patient Satisfaction</p>
                </div>
              </div>
            </div>
