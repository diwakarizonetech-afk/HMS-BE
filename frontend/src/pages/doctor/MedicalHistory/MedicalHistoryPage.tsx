...
export const MedicalHistoryPage: React.FC = () => {
  ...
  const saveOrders = () => {
    ...
    labTestNames.forEach((testName) => {
      createPatientOrderFromOPD({
        patientUhid: patient.uhid || patient.patientId,
        patientName: patient.patientName,
        age: patient.age,
        gender: patient.gender,
        doctorName: patient.admittingDoctor || 'Dr. Vikram Malhotra',
        testName: testName,
        sampleType: 'Blood',
      });
    });
  ...
  return (
    <div className="space-y-6 w-full max-w-7xl mx-auto font-sans text-slate-800">
      ...
      {/* ─── Selected Patient Summary Banner (Clean & Minimal) ───────────────────── */}
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      {/* ─── IPD Patient 9-Section Split Layout (Left Sidebar + Right Content) ────────────── */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        {/* Right Side: Active Section Content Area (Dynamic Height) */}
        <div className="lg:col-span-9 bg-white rounded-2xl border border-slate-200 shadow-2xs p-6">
          ...
          {/* SECTION 2: Clinical Information (In-Place Edit Enabled) */}
          ...
          {/* SECTION 3: Vital Signs (In-Place Edit Enabled) */}
          ...
          {/* SECTION 5: Diagnosis (In-Place Edit Enabled) */}
          ...
          {/* SECTION 6: Doctor Orders (In-Place Edit Enabled) */}
            ...
            <div className="space-y-4">
              ...
              {!isEditingOrders ? (
                ...
                <div className="space-y-4 text-xs bg-slate-50 p-5 rounded-2xl border border-slate-200">
                  {/* Lab Tests Section (Exact Outpatient Consultation Design) */}
                  <div className="bg-white p-4 rounded-2xl border border-purple-200 shadow-2xs space-y-3">
                    ...
                    <div className="space-y-2 pt-1">
                      ...
                      {/* Right-aligned Report Button at Bottom Right (Exact Outpatient Design) */}
          ...
          {/* SECTION 9: Discharge Summary & Status (In-Place Edit & Submit to Discharge) */}
      ...
      {/* ─── Diagnostic Lab Report Modal (Exact OPD Consultation Design) ─── */}
      {isReportModalOpen && (
