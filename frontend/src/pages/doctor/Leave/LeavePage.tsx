...
const DUMMY_LEAVE_STATS: LeaveStatistics = {
  totalCasual: 12, usedCasual: 0,
  totalMedical: 10, usedMedical: 0,
  totalEmergency: 5, usedEmergency: 0,
  totalAnnual: 15, usedAnnual: 0,
};
...
export const LeavePage: React.FC = () => {
  const { user } = useAuth();
  const [leaveRequests, setLeaveRequests] = useState<LeaveRequest[]>(DUMMY_LEAVE_REQUESTS);
  const [statistics] = useState<LeaveStatistics>(DUMMY_LEAVE_STATS);
