...
const DEFAULT_SYSTEM_ROLES: RoleItem[] = [
  ...
  { id: 'role-reception', roleName: 'Receptionist', roleCode: 'RECEPTION', isSystemDefault: true, description: 'Front Desk / Patient Registration', assignedUserCount: 0, permissionsCount: 0, status: 'Active' },
  { id: 'role-store', roleName: 'Store Manager', roleCode: 'STORE', isSystemDefault: true, description: 'Inventory / Purchase Orders', assignedUserCount: 0, permissionsCount: 0, status: 'Active' },
  { id: 'role-lab', roleName: 'Lab Technician', roleCode: 'LAB', isSystemDefault: true, description: 'Pathology & Diagnostic Labs', assignedUserCount: 0, permissionsCount: 0, status: 'Active' },
  { id: 'role-pharmacy', roleName: 'Pharmacist', roleCode: 'PHARMACY', isSystemDefault: true, description: 'Pharmacy Dispensing & Medicine Stock', assignedUserCount: 0, permissionsCount: 0, status: 'Active' },
