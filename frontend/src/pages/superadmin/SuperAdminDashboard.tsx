          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              ...
              >
                ...
                {roles
                  .filter((r) => !['doctor', 'nurse', 'receptionist', 'reception', 'store manager', 'store', 'lab technician', 'lab', 'pharmacist', 'pharmacy', 'cashier', 'billing', 'billing management', 'billing manager', 'finance', 'super admin', 'super_admin', 'admin'].includes(r.roleName.toLowerCase()))
                  .map((r) => (
