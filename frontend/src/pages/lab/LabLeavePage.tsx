...
const DUMMY_LAB_LEAVE_REQUESTS: LeaveRequest[] = [];

const DUMMY_LAB_LEAVE_STATS: LeaveStatistics = {
  totalCasual: 12,
  usedCasual: 0,
  totalMedical: 10,
  usedMedical: 0,
...
export const LabLeavePage: React.FC = () => {
  const { user } = useAuth();
  const [leaveRequests, setLeaveRequests] = useState<LeaveRequest[]>(DUMMY_LAB_LEAVE_REQUESTS);
  const [statistics] = useState<LeaveStatistics>(DUMMY_LAB_LEAVE_STATS);
