          ...
          <table className="w-full text-left border-collapse text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                <td className="py-3 px-4 font-bold text-slate-900">2026-07-27 (Today)</td>
                <td className="py-3 px-4 font-semibold text-cyan-700">Hematology</td>
                <td className="py-3 px-4 font-bold text-slate-800">42</td>
                <td className="py-3 px-4 text-emerald-700 font-bold">38</td>
                <td className="py-3 px-4 text-slate-600">1.8 hrs</td>
                <td className="py-3 px-4 text-rose-600 font-bold">2</td>
                <td className="py-3 px-4 text-right font-black text-slate-900">₹ 28,400</td>
              </tr>
              <tr className="hover:bg-slate-50">
                <td className="py-3 px-4 font-bold text-slate-900">2026-07-27 (Today)</td>
                <td className="py-3 px-4 font-semibold text-purple-700">Biochemistry</td>
                <td className="py-3 px-4 font-bold text-slate-800">58</td>
                <td className="py-3 px-4 text-emerald-700 font-bold">54</td>
                <td className="py-3 px-4 text-slate-600">2.4 hrs</td>
                <td className="py-3 px-4 text-slate-400">0</td>
                <td className="py-3 px-4 text-right font-black text-slate-900">₹ 46,200</td>
              </tr>
              <tr className="hover:bg-slate-50">
                <td className="py-3 px-4 font-bold text-slate-900">2026-07-27 (Today)</td>
                <td className="py-3 px-4 font-semibold text-indigo-700">Endocrinology</td>
                <td className="py-3 px-4 font-bold text-slate-800">24</td>
                <td className="py-3 px-4 text-emerald-700 font-bold">22</td>
                <td className="py-3 px-4 text-slate-600">4.1 hrs</td>
                <td className="py-3 px-4 text-slate-400">0</td>
                <td className="py-3 px-4 text-right font-black text-slate-900">₹ 18,600</td>
              </tr>
              <tr className="hover:bg-slate-50">
                <td className="py-3 px-4 font-bold text-slate-900">2026-07-27 (Today)</td>
                <td className="py-3 px-4 font-semibold text-rose-700">Cardiac Biomarkers</td>
                <td className="py-3 px-4 font-bold text-slate-800">12</td>
                <td className="py-3 px-4 text-emerald-700 font-bold">12</td>
                <td className="py-3 px-4 text-slate-600">0.5 hrs (STAT)</td>
                <td className="py-3 px-4 text-rose-600 font-bold">3</td>
                <td className="py-3 px-4 text-right font-black text-slate-900">₹ 14,400</td>
              </tr>
            </tbody>
          </table>
        </div>
