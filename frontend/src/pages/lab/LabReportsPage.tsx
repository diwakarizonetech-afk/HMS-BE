...
export const LabReportsPage: React.FC = () => {
  ...
  const { testMasterList, sampleCollections, labResults, labReports, selectedBranch, matchBranch } = useLab();
  ...
  const branchResults = React.useMemo(() => {
    return labResults.filter((r) => matchBranch(r.branch));
  }, [labResults, selectedBranch]);
