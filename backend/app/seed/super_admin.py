...
def seed_super_admin() -> None:
    """Idempotent bootstrap: ensures the schema exists and that exactly one
    Super Admin user is present. Safe to call multiple times (e.g. on every
    app startup) -- it will not create duplicates or touch any other data."""
